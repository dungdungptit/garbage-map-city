			...
			<div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item dropdown mr-4">
						<a class="nav-link count-indicator dropdown-toggle d-flex align-items-center justify-content-center notification-dropdown" id="notificationDropdown" href="#" data-toggle="dropdown" onclick="displayNotification()">
							<i class="mdi mdi-bell mx-0"></i>
							<span class="count" id="count"></span>
						</a>
						<div class="dropdown-menu dropdown-menu-right navbar-dropdown noti-drop" aria-labelledby="notificationDropdown" id="modals-notification">
							<p class="mb-0 font-weight-normal float-left dropdown-header">
								Notifications
							</p>
							<a class="dropdown-item">
